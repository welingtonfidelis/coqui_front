  ...
  const handleResetPassword = async (values: any) => {
    ...
    const { ok } = await postService({
      ...
      errorMessage: {
        title: "Falha!",
        message:
          "Houve um erro ao enviar sua mensagem. Por favor, revise os dados inseridos e tente novamente.",
      },
      successMessage: {
        title: "Sucesso!",
        message:
          "Sua mensagem foi enviada para nós. Em breve entraremos em contato.",
      },
    ...
    <div id="contact-page">
      <main>
        ...
        <strong>
          ...
          <br />
          Por favor, preencha os dados abaixo e entraremos em contato o mais
          breve possível.
        </strong>
        ...
        <Form onFinish={handleResetPassword} form={form}>
          ...
          >
            <Input placeholder="Nome" suffix={<UserOutlined />} allowClear />
          </Form.Item>
          ...
          >
            <InputTextArea placeholder="Mensagem" allowClear />
          </Form.Item>
          ...
          <ButtonPrimary htmlType="submit" loading={userInfo.loadingLogin}>
            Enviar
          </ButtonPrimary>
        </Form>
